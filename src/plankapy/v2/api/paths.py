...
class PlankaEndpoints:
	...
	def acceptTerms(self, **body: Any) -> Any:
		...
		return self.client.post("api/access-tokens/accept-terms".format(**params), data=body)
	...
	def exchangeForAccessTokenWithOidc(self, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/access-tokens/exchange-with-oidc".format(**params), data=body)
	...
	def revokePendingToken(self, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/access-tokens/revoke-pending-token".format(**params), data=body)
	...
	def createAttachment(self, cardId: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/cards/{cardId}/attachments".format(**params), data=body)
	...
	def createBackgroundImage(self, projectId: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/projects/{projectId}/background-images".format(**params), data=body)
	...
	def createBaseCustomFieldGroup(self, projectId: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/projects/{projectId}/base-custom-field-groups".format(**params), data=body)
	...
	def updateBaseCustomFieldGroup(self, id: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.patch("api/base-custom-field-groups/{id}".format(**params), data=body)
	...
	def createBoardMembership(self, boardId: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/boards/{boardId}/board-memberships".format(**params), data=body)
	...
	def updateBoardMembership(self, id: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.patch("api/board-memberships/{id}".format(**params), data=body)
	...
	def createBoard(self, projectId: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/projects/{projectId}/boards".format(**params), data=body)
	...
	def createCardLabel(self, cardId: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/cards/{cardId}/card-labels".format(**params), data=body)
	...
	def deleteCardLabel(self, cardId: str, labelId: str) -> Any:
		...
		params = locals().copy()
		params.pop('self')
		return self.client.delete("api/cards/{cardId}/card-labels/labelId:{labelId}".format(**params))
	...
	def createCardMembership(self, cardId: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/cards/{cardId}/card-memberships".format(**params), data=body)
	...
	def deleteCardMembership(self, cardId: str, userId: str) -> Any:
		...
		params = locals().copy()
		params.pop('self')
		return self.client.delete("api/cards/{cardId}/card-memberships/userId:{userId}".format(**params))
	...
	def getCards(self, listId: str, before: str, search: str, filterUserIds: str, filterLabelIds: str) -> Any:
	...
	def createComment(self, cardId: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/cards/{cardId}/comments".format(**params), data=body)
	...
	def createBoardCustomFieldGroup(self, boardId: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/boards/{boardId}/custom-field-groups".format(**params), data=body)
	...
	def createCardCustomFieldGroup(self, cardId: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/cards/{cardId}/custom-field-groups".format(**params), data=body)
	...
	def updateCustomFieldGroup(self, id: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.patch("api/custom-field-groups/{id}".format(**params), data=body)

	def updateCustomFieldValue(self, cardId: str, customFieldGroupId: str, customFieldId: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.patch("api/cards/{cardId}/custom-field-values/customFieldGroupId:{customFieldGroupId}:customFieldId:${customFieldId}".format(**params), data=body)

	def deleteCustomFieldValue(self, cardId: str, customFieldGroupId: str, customFieldId: str) -> Any:
		...
		params = locals().copy()
		params.pop('self')
		return self.client.delete("api/cards/{cardId}/custom-field-value/customFieldGroupId:{customFieldGroupId}:customFieldId:${customFieldId}".format(**params))

	def createCustomFieldInBaseGroup(self, baseCustomFieldGroupId: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/base-custom-field-groups/{baseCustomFieldGroupId}/custom-fields".format(**params), data=body)
	...
	def createCustomFieldInGroup(self, customFieldGroupId: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/custom-field-groups/{customFieldGroupId}/custom-fields".format(**params), data=body)
	...
	def createLabel(self, boardId: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/boards/{boardId}/labels".format(**params), data=body)
	...
	def createList(self, boardId: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/boards/{boardId}/lists".format(**params), data=body)
	...
	def createBoardNotificationService(self, boardId: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/boards/{boardId}/notification-services".format(**params), data=body)
	...
	def createUserNotificationService(self, userId: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/users/{userId}/notification-services".format(**params), data=body)
	...
	def updateNotificationService(self, id: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.patch("api/notification-services/{id}".format(**params), data=body)
	...
	def createProjectManager(self, projectId: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/projects/{projectId}/project-managers".format(**params), data=body)
	...
	def createTaskList(self, cardId: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/cards/{cardId}/task-lists".format(**params), data=body)
	...
	def createTask(self, taskListId: str, **body: Any) -> Any:
		...
		params.pop('self')
		body = params.pop('body')
		return self.client.post("api/task-lists/{taskListId}/tasks".format(**params), data=body)
